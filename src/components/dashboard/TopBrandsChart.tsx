...
export function TopBrandsChart({ data }: TopBrandsChartProps) {
  return (
    <motion.div
      ...
      className="bg-navy-900/50 backdrop-blur-md p-4 md:p-6 col-span-1 border border-white/10 rounded-xl"
    >
      <div className="flex items-center justify-between mb-4 md:mb-6">
        <div>
          <h2 className="text-base md:text-lg font-bold text-white flex items-center gap-2">
            <Trophy size={16} className="text-[rgb(var(--accent-lime))] w-4 h-4 md:w-auto md:h-auto" />
            Top 10 Marcas
          </h2>
          <p className="text-[10px] md:text-xs text-gray-400">Participación en las últimas 24h</p>
        </div>
      </div>
