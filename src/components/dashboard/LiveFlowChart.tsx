...
export function LiveFlowChart({ data }: LiveFlowChartProps) {
  return (
    <motion.div 
      ...
      className="bg-navy-900/50 backdrop-blur-md p-6 col-span-1 lg:col-span-2 border border-white/10 rounded-xl relative overflow-hidden"
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-gray-400">Últimas 24 horas - Todas las pantallas</p>
        </div>
        <div className="flex gap-4 text-xs font-medium">
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-[rgb(var(--accent-cyan))] shadow-[0_0_8px_rgba(var(--accent-cyan),0.8)]"></div>
            <span className="text-gray-300">Total Vehículos</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-[rgb(var(--accent-magenta))] shadow-[0_0_8px_rgba(var(--accent-magenta),0.8)]"></div>
            <span className="text-gray-300">Segmento Premium</span>
          </div>
        </div>
      </div>
