...
`;
  ...
  const adScoreExplanation = `
┌─────────────────────────────────────────────────────────────┐
│                    ¿QUÉ ES EL AD SCORE?                     │
├─────────────────────────────────────────────────────────────┤
│                                                             │
│  El Ad Score es un puntaje del 0 al 100 que mide el VALOR  │
│  PUBLICITARIO de una pantalla digital basado en:           │
│                                                             │
│  ┌─────────────────────┐  ┌─────────────────────────────┐  │
│  │   VOLUMEN (40%)     │  │   PREMIUM RATIO (60%)       │  │
│  │                     │  │                             │  │
│  │  Cantidad total de  │  │  Porcentaje de vehículos    │  │
│  │  vehículos que      │  │  de marcas premium (BMW,    │  │
│  │  transitan por la   │  │  Mercedes, Audi, etc.) que  │  │
│  │  pantalla.          │  │  pasan frente a la pantalla.│  │
│  └─────────────────────┘  └─────────────────────────────┘  │
│                                                             │
│  FÓRMULA:                                                   │
...
│  │                                                      │  │
│  │  🟢 70-100: ALTO VALOR                               │  │
│  │     → Ideal para marcas de lujo, tecnología,         │  │
│  │       bancos premium, aseguradoras.                  │  │
│  │     → Audiencia con alto poder adquisitivo.          │  │
│  │                                                      │  │
│  │  🔵 40-69: VALOR MEDIO                               │  │
│  │     → Ideal para retail, consumo masivo,             │  │
│  │       telecomunicaciones.                            │  │
│  │     → Audiencia segmento medio.                      │  │
│  │                                                      │  │
│  │  🔴 0-39: BAJO VALOR                                 │  │
│  │     → Ideal para marcas de descuento,                │  │
│  │       servicios básicos, educación masiva.           │  │
│  │     → Audiencia segmento C3-D.                       │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                             │
│  EJEMPLO PRÁCTICO:                                          │
│  • Pantalla en Vitacura: 85/100 (Alto valor)               │
│    → 3000 vehículos/día, 45% premium                       │
│    → Recomendado: BMW, Mercedes, Banco Privado             │
│                                                             │
│  • Pantalla en Puente Alto: 42/100 (Valor medio)           │
│    → 5000 vehículos/día, 12% premium                       │
│    → Recomendado: Lider, Easy, Movistar                    │
└─────────────────────────────────────────────────────────────┘
`;
